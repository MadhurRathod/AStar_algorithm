...
public class AStarPathFinding : MonoBehaviour
{
    ...
    void BeginSearch()
    {
        ...
        startNode = new PathMarker(new MapLocation(locations[0].x * maze.scale, locations[0].z * maze.scale), 0, 0, 0,
            Instantiate(start, startLocation, Quaternion.identity), null);

        Vector3 goalLocation = new Vector3(locations[1].x * maze.scale, 0, locations[1].z * maze.scale);
        goalNode = new PathMarker(new MapLocation(locations[1].x * maze.scale, locations[1].z * maze.scale), 0, 0, 0,
